        ...
        <div className="hero-visuals">
          <div className="product-showcase" data-aos="fade-left" data-aos-delay="200">
            <div className="product-card featured">
              <img src="src/assets/images/products/image-1.jpeg" alt="Featured Product" className="img-fluid"/>
            ...
            <div className="product-grid">
              <div className="product-mini" data-aos="zoom-in" data-aos-delay="400">
                <img src="src/assets/images/products/image-2.jpeg" alt="Product" className="img-fluid"/>
                <span className="mini-price">$89</span>
              </div>
              <div className="product-mini" data-aos="zoom-in" data-aos-delay="500">
                <img src="src/assets/images/products/image-5.jpeg" alt="Product" className="img-fluid"/>
